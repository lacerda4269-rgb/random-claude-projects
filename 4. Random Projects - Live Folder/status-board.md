...
*Items that cannot move forward and why.*

| Item | Phase | Blocker | Owner | Since |
|------|-------|---------|-------|-------|
...
*Items parked by choice — not blocked by a dependency, but not being worked right now.*
...
*Last few completed milestones — rolling. Older completions live in Session Summary.*
